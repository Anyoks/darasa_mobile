            ...
            var sharer = this.getValue('sharer'),
                ...
                sharers = {
                    ...
                    whatsapp: function () {
                        ...
                        params = {
                            text: that.getValue('title') + ' ' + that.getValue('url') + ' Sent via Abacus'
                        };
                        that.urlSharer(shareUrl, params, true);
                    },
                    telegram: function () {
        ...
        urlSharer: function(shareUrl, params, isLink) {
            ...
            if (!isLink) {
                var dualScreenLeft = window.screenLeft != undefined ? window.screenLeft : screen.left,
                    ...
                    newWindow = window.open(shareUrl, '_system', popParams);
                ...
                window.open(shareUrl, '_system', 'location=no');
            }
        }
    };
